...
Here's a complete example of using templates in a NextJS [app router](https://nextjs.org/docs/app) project ([live demo](https://usellm.org/demo/tutorial-generator)):
